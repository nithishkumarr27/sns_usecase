      ...
      <div className="flex-1 flex mx-auto flex-col justify-center ">
        ...
        <motion.div style={{ opacity: firstOpacity }}>
          <div className="max-w-full  ">
            <div className="grid grid-cols-1  gap-12 lg:gap-16 items-center mr-4">
              <div className="">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-manrope font-bold text-black leading-tight mb-12">
