...
const Home = () => {
  ...
  return (
    <div className="w-full bg-white min-h-screen">
      ...
      <div className="relative w-full overflow-hidden py-16 px-4 h-[800px]" style={{ backgroundImage: "url('/images/Full-bg.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className='flex justify-center relative gap-4'>
          <div>
            <button 
              className={`font-semibold py-2 px-4 rounded-full shadow hover:shadow-lg transition ${
                activeButton === 'Foundation Agents' 
